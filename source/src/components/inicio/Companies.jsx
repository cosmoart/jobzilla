			...
			<div className='grid md:grid-cols-[repeat(auto-fit,minmax(500px,1fr))] gap-4 justify-center flex-wrap md:px-6 2xl:px-0'>
				{
					companies.map((company, index) => (
						<Link href={`/empresa?sdrn=${company.sdrn}`} key={index} className='bg-gray-100 rounded-md flex items-center overflow-hidden grow hover:bg-gray-200 dark:hover:bg-gray-900 dark:bg-gray-800 data:hover:bg-gray-900 hover:scale-[1.01] transition-all shadow flex-col md:flex-row'>
