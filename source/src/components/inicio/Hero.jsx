...
export default function Hero () {
	...
	return (
		<main className='h-[60vh] section flex items-start max-h-[30rem] after:top-0 after:absolute after:w-full after:bg-center after:h-[85vh] after:bg-fixed after:-z-10 after:bg-cover after:blur-[2px] after:brightness-75 after:bg-[url("https://images.pexels.com/photos/209726/pexels-photo-209726.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")]' data-dark-header='false'>
			<div className='mx-auto max-w-7xl flex flex-col gap-6 justify-center h-full'>
				<h1 className='text-5xl font-bold text-white'>Busca el trabajo de tus sueños</h1>
