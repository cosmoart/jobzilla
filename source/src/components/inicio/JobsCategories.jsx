	...
	return (
		<section className='my-20'>
			...
			<div className='relative'>
				<button className='absolute z-10 top-1/2 -trangray-y-1/2 left-0 rotate-180 bg-linear-to-r from-transparent to-white dark:to-gray-700 h-full p-2 ' onClick={() => { document.querySelector('#scrollX').scrollLeft -= 100 }}>
				...
				<button className='absolute z-10 top-1/2 -trangray-y-1/2 right-0 bg-linear-to-r from-transparent to-white dark:to-gray-700 h-full p-2 ' onClick={() => { document.querySelector('#scrollX').scrollLeft += 100 }}>
