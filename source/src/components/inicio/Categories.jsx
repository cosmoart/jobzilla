...
export default function Categories () {
	return (
		<div className='section flex-wrap items-center justify-center gap-8 text-center sm:flex mb-10'>
			<div className='w-full px-4 py-4 mt-6 bg-white rounded-lg shadow-lg sm:w-1/2 md:w-1/2 lg:w-1/4 dark:bg-slate-800'>
				...
				<h3 className='pt-4 text-2xl font-semibold text-slate-700 sm:text-xl dark:text-white'>
					Empleos
				</h3>
				<p className='py-4 text-slate-500 text-md dark:text-slate-300'>
					Busca entre nuestra lista de trabajos y encuentra el que más se adapte a tus necesidades.
				</p>
			</div>
			<div className='w-full px-4 py-4 mt-6 bg-white rounded-lg shadow-lg sm:w-1/2 md:w-1/2 lg:w-1/4 sm:mt-16 md:mt-20 lg:mt-24 dark:bg-slate-800'>
				<div className='flex-shrink-0'>
					<div className='flex items-center justify-center w-12 h-12 mx-auto text-white bg-blue-500 rounded-md'>
