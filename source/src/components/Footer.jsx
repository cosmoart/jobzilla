...
export default function Footer () {
	...
	// return (
	// 	<footer className='py-5 px-6 bg-white dark:bg-gray-800'>
	...
	// 				{
	// 					links.map((link, index) => (
	// 						<Link href={link.href} key={index} className='hover:text-gray-700 dark:hover:text-gray-200  hover:trangray-x-1 transition-all'>
	// 							{link.name}
	// 						</Link>
	// 					))
	// 				}
	...
	// 				</a>
	// 				<p className='mt-1'>
	// 					Creado con ❤️ por <a className='underline hover:text-primary-gray-20' target='_blank' rel='noopener noreferrer' href='https://github.com/cosmoart'>Cosmo</a>
	// 				</p>
	// 			</div>
	// 		</div>
	// 	</footer>
