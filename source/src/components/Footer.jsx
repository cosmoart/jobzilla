...
export default function Footer () {
	return (
		...
		<footer className='px-3 py-8 text-gray-500 transition-colors duration-200 bg-white dark:bg-gray-800 text-2 dark:text-gray-200 flex flex-grow justify-center items-end'>
			<div className='flex flex-col'>
				...
				<div className='flex flex-col mt-4 md:mt-0 md:flex-row'>
					<nav className='flex flex-col items-center justify-center flex-1 border-gray-100 md:items-end md:border-r md:pr-5'>
						<Link aria-current='page' href='/' className='hover:text-gray-700 dark:hover:text-white'>
							Inicio
						</Link>
						<Link aria-current='page' href='/buscador-empleos' className='hover:text-gray-700 dark:hover:text-white'>
							Buscar empleo
						</Link>
					...
					<div className='flex flex-col items-center justify-center flex-1 mt-7 md:mt-0 md:items-start md:pl-5'>
						<span className=''>
							<a href='https://github.com/cosmoart/jobzilla' target='_blank' rel='noopener noreferrer' title='La información que se muestra se ha obtenido a través de la API de Infojobs y está sujeta a los términos y condiciones de Infojobs.'>Licencia MIT</a>
						</span>
						<span className='mt-7 md:mt-1'>
							Creado con ❤️ por <a className='underline hover:text-primary-gray-20' target='_blank' rel='noopener noreferrer' href='https://github.com/cosmoart'>
								Cosmo
							</a>
						</span>
					</div>
