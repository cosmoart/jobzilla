		...
		<header className='group darkHeader shadow backdrop-blur sticky top-0 w-full z-40 '>
			<nav className='mx-auto max-w-7xl'>
				<div className='flex relative gap-5 py-4 px-6 2xl:px-0 justify-center items-center font-normal'>
					...
					<div className={`grow flex justify-end ${screenWidth < 924 ? '' : 'hidden'}`}>
					...
					<div className={`flex shadow md:shadow-none items-center gap-5 rounded-md grow top-0 ${screenWidth < 924 ? 'flex-col absolute transition-all items-end px-5 py-2 right-0 dark:bg-gray-700 bg-white ' : ''} ${screenWidth < 924 && (showMenu ? 'top-14	opacity-100' : 'opacity-0 pointer-events-none -z-10')}`}>
